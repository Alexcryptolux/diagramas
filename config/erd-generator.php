...
return [
    ...
    'ignore' => [
        ...
        //     'user'
        // ]
        //App\Models\Factura::class,
        //App\Models\Paciente::class,
        //App\Models\Historia::class,
        //App\Models\Detfactura::class,
    ...
    */
     ...
     */
    'table' => [
        'header_background_color' => '#d3d3d3', //titulo tabla
        'header_font_color' => '#333333', //fuente titulo
        'row_background_color' => '#ffffff', //fondo tabla
        'row_font_color' => '#333333', // fuente
    ],
